...
public class AdmissionForm_ViaExcel extends BaseTest{
	// page Factory
...
//promotional Code***************
	...
	public AdmissionForm_ViaExcel(WebDriver driver) {
		this.driver = driver;
	...
	//	Select select6 = new Select(employee_ReferenceID_dropdown);
		//state_dropdown.sendKeys(rEmployeeName);
		
		wait.until(ExpectedConditions.visibilityOf(rSibling_AdmissionID));
		rSibling_AdmissionID.sendKeys(referenceAdmissionID);
