...
public class Corporate_Admissions extends BaseTest {
		...
		public Corporate_Admissions(WebDriver driver) {
			this.driver = driver;
		...
		public void OpenCorporateAdmision_OnlineForm() throws InterruptedException {
			driver.get(Corporate_Admission_URL);
		}
		
//Corporate Admission Via Invite Link
		
		public void setChild_form(String socialMedia,String gender,String bloodGp,String program,String state,
	        ...
	        Images(); // photo upload method for uploading child, father & mother's photo
